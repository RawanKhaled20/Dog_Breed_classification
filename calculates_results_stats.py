...
def calculates_results_stats(results):
    ...
    for key in results:
        ...
        if results[key][0] in results[key][1]:
            # Check if the key corresponds to a dog image
            if results[key][3] == 1:
                results_stats_dic['n_correct_breed'] += 1  # Increment n_correct_breed
        ...
        if results[key][3] == 1:
            ...
            if results[key][3] == 0 and results[key][4] == 0:
                results_stats_dic['n_correct_notdogs'] += 1  # Increment n_correct_notdogs
    ...
    # Calculate the percentage of correctly matched images
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / results_stats_dic['n_images']) * 100.0

    # Calculate the percentage of correctly classified dog images
    ...
    if results_stats_dic['n_dogs_img'] > 0:
        print(results_stats_dic['n_correct_breed'])
        ...
        # Check if there are non-dog images
    if results_stats_dic['n_notdogs_img']>0:
        # Calculate the percentage of correctly classified non-dog images
